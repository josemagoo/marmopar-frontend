      ...
      <div className="container py-16 grid lg:grid-cols-2 gap-10 lg:gap-20">
        <div>
          <h3
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-2xl text-acgroup-primary font-bold"
          >
            ¡Contactenos!
          </h3>
          <p
          ...
          <div className="pt-10 border-t-4 mt-5 border-acgroup-primary">
            <svg
              width="226"
              height="196"
              viewBox="0 0 226 196"
        ...
        <div>
          <div>
            <h3
              data-aos="fade-up"
              data-aos-delay="200"
              className="text-acgroup-primary text-2xl font-bold mb-3"
            >
            ...
            >
              Trasladamos tu carga desde y hacia cualquier parte del
              mundo. Esperamos tu consulta, escribínos o solicitá tu
              presupuesto.
            </p>
            ...
            >
              <div>
                ...
                <div className="flex mt-5">
                  <button
                    type="submit"
                    className="block placeholder:text-neutral-800 px-10 rounded-full text-white  py-2 bg-acgroup-secondary"
                  >
